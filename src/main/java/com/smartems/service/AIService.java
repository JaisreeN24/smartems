...
public class AIService {
    ...
    public String classifySeverity(String description) {
        ...
        if (apiKey == null || apiKey.isBlank()) return fallbackClassify(description);
        ...
        try {
            ...
            if (isFollowUp) {
                String context = emergencyDescription.substring(
                    ...
                    emergencyDescription.indexOf("User question:")
                ).trim();
                String question = emergencyDescription.substring(
                    emergencyDescription.indexOf("User question:") + 14
                ).trim();
